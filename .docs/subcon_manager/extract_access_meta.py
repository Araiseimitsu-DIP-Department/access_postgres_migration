"""Access DB メタデータ抽出（subcon_manager）。"""
...
DB_PATH = r"C:\Users\seizo\Desktop\協力会社委託加工処理品DB.accdb"
OUT_PATH = Path(__file__).resolve().parent / "協力会社委託加工処理品DB_meta.json"
...
def main() -> None:
    ...
    for table in tables:
        ...
        for col in table["columns"]:
            print(f"    - {col['name']} ({col['access_type']})")
