...
- 実行日時: 2026-06-15 13:15:29
- Access DB: C:\Users\seizo\my_projects\1\access_postgres_migration\.docs\material_scheduling\セット予定材料管理DB.accdb

| Accessテーブル名 | PostgreSQLテーブル名 | Access件数 | PostgreSQL件数 | 投入済み件数 | 状態 | エラー |
|---|---|---:|---:|---:|---|---|
| t_コントロール | app_control | 1 | 1 | 1 | 成功 |  |
| t_セット予定 | set_schedules | 5182 | 5182 | 5182 | 成功 |  |
...
| t_生産発注 | production_orders | 6329 | 6329 | 6329 | 成功 |  |
| t_発注者マスタ | orderer_master | 7 | 7 | 7 | 成功 |  |
| t_管理表マスタ | management_sheet_master | 1519 | 1519 | 1519 | 成功 |  |
